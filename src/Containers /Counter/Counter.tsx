...
const Counter = () => {
  ...
  return (
    <div>
      ...
      <div
        className="w-25 ms-5 mt-5 p-4 border border-secondary"
      ...
      <div className="row w-25 ms-5">
        ...
        <button
          className="col-4 p-5 fs-2"
          onClick={() => dispatch(checkpaswordDoor())}
        >
          E
        </button>
        <button
          className="col-4 p-5 fs-2"
          onClick={() => dispatch(deleteNumberPassword())}
        >
          {" "}
          x{" "}
        </button>
